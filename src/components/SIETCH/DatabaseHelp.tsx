...
access_level: public`}</CodeBlock>
        ...
        <TabPanel header="Удаление">
          <Panel header="Раздел в разработке">
            <p className="text-500">
              Функционал удаления записей, связанных дампов и полной очистки
              базы будет добавлен на следующем шаге разработки. После этого
              раздел наполнится инструкциями и предупреждениями о
              необратимости операций.
            </p>
            <p className="text-500 mt-2">
              <b>Сейчас</b> удалить запись напрямую из базы нельзя — используйте
              статус <code>false</code> или <code>archived</code>.
            </p>
          </Panel>
        </TabPanel>
