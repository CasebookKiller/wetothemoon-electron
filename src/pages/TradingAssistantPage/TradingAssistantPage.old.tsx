console.log('TradingAssistantPage mounted');
...
//import { useStreamProfile } from '@/hooks/useStreamProfile';
//import { StreamTab } from '@/components/TRADING_ASSISTANT/StreamTab/StreamTab';
    ...
    <div className="trading-assistant">
      ...
      {true && activeTab === 'sandbox' && (
        ...
        /*<SandboxTab
          ...
          handlePayIn={handlePayIn}
          applyConfig={applyConfig}
          toggleTrading={toggleTrading}
          autoTrading={autoTrading}
        />*/
      )}
      {true && activeTab === 'stream' && (
        renderStreamPanel()
        /*<StreamTab
          stream={stream}
      ...
      {true && activeTab === 'signals' && renderSignalsPanel()/*<SignalsTab liveSignals={liveSignals} />*/}
      {true && activeTab === 'profile' && renderProfilePanel()/*<ProfileTab profile={profile} />*/}
      {true && activeTab === 'trades' && renderTradesPanel()/*<TradesTab trades={backtest.trades} />*/}
      {true && activeTab === 'batch' && renderBatchPanel()/*(
        <BatchTab
